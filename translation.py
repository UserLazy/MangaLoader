...
class Translation(object):
    ...
    HELP_TEXT = "How to use MangaLoader?!\n\n1. Sent manga url from [supported resources](https://github.com/X-Gorn/MangaLoader/tree/cleandir#url-options-and-examples).\n2. Choose subdir option. (will uploaded as Zipfile)\n3. Wait a few minutes and you will recieve your archived manga\n\nIf bot didn't respond, contact @xgorn"
